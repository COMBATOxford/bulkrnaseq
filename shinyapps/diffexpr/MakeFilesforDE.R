...
# corfit <- duplicateCorrelation(logcpm[, !(is.na(s.info$Charlson))],
# designagesexcharlson,
# block=s.info$baseID[!(is.na(s.info$Charlson))])
# corfit$consensus # 0.4167762
corcons <- 0.4167762
...
# save(fitagesexcharlson, designagesexcharlson,
# file="DEfitagesexcharlson.Rdata")
